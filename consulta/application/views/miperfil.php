<?php
foreach (Miperfil() as $key) {
	$dashboard = $key["dashboard"] ;
	$miperfil = $key["miperfil"] ;
...
<head>
    ...
    <link rel="stylesheet" href="<?=assetmiperfil()?>/css/ionicons.css"> 
    <link rel="stylesheet" href="<?=assetmiperfil()?>/css/AdminLTE.css"> 
    <link rel="stylesheet" href="<?=assetmiperfil()?>/css/skin-black-light.css"> 
    <link rel="stylesheet" href="<?=assetmiperfil()?>/css/chosen.css">   
    <link rel="stylesheet" href="<?=assetmiperfil()?>/css/ImageSelect.css"> 
    <link rel="stylesheet" href="<?=assetmiperfil()?>/css/bootstrap-timepicker.css">
    <link rel="stylesheet" href="<?=assetmiperfil()?>/css/styles.css">
    <link rel="stylesheet" href="<?=assetmiperfil()?>/css/estiloform.css"> 
    <link rel="stylesheet" href="<?=assetmiperfil()?>/css/slick.css"> 
    <link rel="stylesheet" href="<?=assetmiperfil()?>/css/fullcalendar.css"> 
    <link href="https://fonts.googleapis.com/css?family=Lato:300,400,700,900&display=swap" rel="stylesheet">
    <script src="<?=assetmiperfil()?>/js/jquery.js"></script> 

    <script src="<?=assetmiperfil()?>/js/bootstrap.js"></script> 
    <script src="<?=assetmiperfil()?>/js/bootstrap-timepicker.js"></script> 
    <!-- daterangepicker -->
    <script src="<?=assetmiperfil()?>/js/moment.js"></script>    
    <!-- AdminLTE App -->
    <script src="<?=assetmiperfil()?>/js/adminlte.js"></script>
    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="<?=assetmiperfil()?>/js/fullcalendar.js"></script>
    <script src="<?=assetmiperfil()?>/js/es.js"></script>
 
  <script src="<?=assetmiperfil()?>/js/chosen.js" type="text/javascript"></script>
    <script src="<?=assetmiperfil()?>/js/ImageSelect.jquery.js" type="text/javascript"></script>
    <script src="<?=assetmiperfil()?>/js/jquery.mask.js"></script>
 ...
 <body class="hold-transition skin-black-light sidebar-mini">
     <div class="wrapper"> 
        ...
        <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-lg">
                        <b class="letrasyeschef">Yes Chef</b>
                    </span>
                </a>
                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item" style="">
                            <a class="nav-link " href="#" style="padding-left: 0px;margin-right: 20px;">
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="contimgusprincipal image">
                            <img src="<?=assetmiperfil()?>/img/yeschef.png" class="imgusprincipal img-circle" alt="Yes chef">
                        </div>
                        <div class="info">
                            <a href="#">
    ...
    <?=$contenido?> 
     ...
     <!-- ./wrapper -->
<footer class=" futerrojo">&copy;YES - CHEF 2019. All rights
        reserved.
    </footer>    
    ...
    <script type="text/javascript">
        var editable = <?=$editable?>;
         if (editable!="") {
             $.ajax({
                url: "<?=base_url('Consultas/general/')?>"+editable,
                type: 'POST',
                dataType: 'html',
                data: { 
                    editable: editable, 
                ...
                $("#contenidoedicion").html(respuestas); 
            });
                $(".center").slick({ 
        dots: false,
        infinite: true,
